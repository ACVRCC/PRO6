...
//	@Produces(MediaType.TEXT_PLAIN)
	...
	@GET
	@Path("/ListMusic/{id}") //ACEDER ATRAVÉS DO PATH http://localhost:8080/thews-ws/rest/Playlist/ListMusic
...
@GET
@Path ("/Addmusic/{idmusic}/{idplaylist}") //Aceder através do path: http://localhost:8080/thews-ws/rest/Playlist/Addmusic
//Serviço nº 17
@Produces(MediaType.APPLICATION_XML)
public void addMusicPlaylist(@PathParam ("idmusic") int idmusic, @PathParam ("idplaylist") int idplaylist ){	
...
@GET
@Path ("/Deletemusic/{idmusic}/{idplaylist}") //Aceder através do path: http://localhost:8080/thews-ws/rest/Playlist/Deletemusic/
//Serviço nº 17
@Produces(MediaType.APPLICATION_XML)
public void DeleteMusicFromPlaylist(@PathParam ("idmusic") int idmusic, @PathParam ("idplaylist") int idplaylist ){	
	MusicEntity m = musics.getMusicFromId(idmusic);
